/**
 * =============================================================================
 * VN Map Partner – countrymap.js  (PLACEHOLDER)
 * =============================================================================
 *
 ...
 *   3. Tìm và tải file: .../cssmap/countrymap.js
 *   4. Sao chép nội dung file đó và thay thế toàn bộ nội dung file này
 *
 * Đây là engine render bản đồ của simplemaps (thư viện thương mại).
 * =============================================================================
 */
    ...
    !(function (t, N) {
      ...
      var at = function (t) {
        if (j.vml) {
          ...
          ((s.title = "RaphaÃ«l Colour Picker"),
                ...
                ((this.bottom = this.top = null),
                  (this.desc = L("desc")).appendChild(
                    j._g.doc.createTextNode(
                      "Created with RaphaÃ«l " + j.version,
                    ),
                  ),
...
var simplemaps_countrymap_mapinfo = {
  ...
  names: {
    VNM489: "Quáº£ng Trá»‹",
    VNM488: "Quáº£ng NgÃ£i",
    VNM481: "Ninh Thuáº­n",
    VNM480: "LÃ¢m Äá»“ng",
    VNM483: "BÃ¬nh DÆ°Æ¡ng",
    VNM482: "PhÃº YÃªn",
    VNM485: "BÃ¬nh Äá»‹nh",
    VNM484: "BÃ¬nh PhÆ°á»›c",
    VNM487: "QuÃ ng Nam",
    VNM486: "Kon Tum",
    VNM5483: "LÃ o Cai",
    VNM4835: "Äáº¯k NÃ´ng",
    VNM4834: "Tiá»n Giang",
    VNM501: "Há»“ ChÃ­ Minh city",
    VNM512: "HÃ  Giang",
    VNM511: "Cao Báº±ng",
    VNM510: "VÄ©nh Long",
    VNM478: "Gia Lai",
    ...
    VNM499: "Can Tho",
    VNM475: "Nghá»‡ An",
    VNM490: "Thá»«a ThiÃªn - Huáº¿",
    VNM491: "ÄÃ  Náºµng",
    VNM496: "BÃ¬nh Thuáº­n",
    VNM497: "ÄÃ´ng Nam Bá»™",
    VNM495: "BÃ  Rá»‹a - VÅ©ng TÃ u",
    VNM470: "Báº¯c Giang",
    VNM4600: "Háº£i PhÃ²ng",
    VNM471: "ThÃ¡i BÃ¬nh",
    VNM503: "Long An",
    VNM467: "HÃ  Nam",
    VNM466: "Ninh BÃ¬nh",
    ...
    VNM463: "Báº¯c Ninh",
    VNM462: "Ha Noi",
    VNM461: "Äá»“ng Báº±ng SÃ´ng Há»“ng",
    VNM460: "Háº£i DÆ°Æ¡ng",
    VNM474: "Ha Tinh",
    VNM469: "PhÃº Thá»",
    VNM468: "Nam Äá»‹nh",
    VNM508: "SÃ³c TrÄƒng",
    VNM509: "TrÃ  Vinh",
    VNM476: "Quáº£ng BÃ¬nh",
    VNM500: "Ã?ng ThÃ¡p",
    VNM444: "TÃ¢y Ninh",
    VNM502: "KiÃªn Giang",
    VNM477: "Dak Lak",
  ...
  function p() {
        ...
        Je = function (t, e) {
          if (t) {
            ...
            if ((je.hide(), Qo(t)))
              ...
              if (it && "location" == t.sm.type && "image" == t.sm.shape_type)
                return;
              if (!t || !t.sm) return;
              (t.sm.ignore_hover ||
                (i
                  ? (t.attr(t.sm.attributes), n())
                  : t.animate(t.sm.attributes, D, n)),
                Xo(t, "out"));
            }
          } else e();
    ...
    function vo(t) {
      if (
        ...
        b
          ...
          : ((xt = void 0 === _.width ? 800 : _.width),
            (ht.style.width = xt + "px")),
        (xt *= 1),
        n.calibrate
      ...
      if (r)
        if (location.hostname.match("simplemaps.com")) r = !1;
          ...
          ((Le.style.cssText =
            ...
            503 != Le.innerHTML.length && (_t.innerHTML = ""));
        }
    }
                  ...
                  if ((void 0 === e && (e = "z"), z && "region" != z.sm.type))
                    ...
                    if (
                      ...
                      !(function (t) {
                        ...
                        if (o && e > ve[-1].sm.zooming_dimensions.w - 1)
                          return (w || Oo(ve[-1]), !1);
                        return !0;
                      })(t)
                    )
                    ...
                    var i = (function (t, e) {
                      ...
                      if ("x" == e)
                        var n =
                          ye.sm.zooming_dimensions.x +
                          ye.sm.zooming_dimensions.w * t;
                      else if ("y" == e)
                        var a =
                          ye.sm.zooming_dimensions.y +
                          ye.sm.zooming_dimensions.h * t;
                      else
                        var o = ye.sm.zooming_dimensions.w / t,
                          i = ye.sm.zooming_dimensions.h / t,
                          n =
                            ye.sm.zooming_dimensions.x +
                            (ye.sm.zooming_dimensions.w - o) / 2,
                          a =
                            ye.sm.zooming_dimensions.y +
                            (ye.sm.zooming_dimensions.h - i) / 2;
    ...
    function bo() {
      ...
      (!(function () {
        ...
        for (var n in E)
          for (var a in ((ne[n] = Object.create(t)),
          E[n].url && (ne[n].zoomable = !1),
          E[n]))
            ...
            Yt.forEach(function (o) {
              o.sm.hide ||
                ...
                o.sm.scale &&
                  Ao(
                    o,
                    Wo(o, (Ct > o.sm.scale_limit ? Ct : o.sm.scale_limit) * kt),
                    e,
                  ));
            }));
        })(t, e),
          ...
          for (var o in (Xt.hide(), be)) {
            ...
            if (!i.sm.hide) {
              ...
              if (i.sm.scale) {
                var a = Wo(
                  i,
                  (Ct > i.sm.scale_limit ? Ct : i.sm.scale_limit) * kt,
                );
        ...
        "region" == i
          ...
          : "state" == i
            ...
            : "manual" == i &&
              Wt.forEach(function (t) {
                -1 != t.sm.id &&
                  (t.sm.zooming_dimensions.r > Ct && t.sm.zoomable
                    ? ko(t)
                    : zo(t));
              }),
        "out" != i && "manual" != i
    ...
    function To(t) {
      if (w && "-1" != x && "region" == t.sm.type) {
        ...
        "state" == t.sm.type || "region" == t.sm.type || j
          ? Zt.show()
          : g && "out" != t.sm.type && Zt.show();
    }
    ...
    function Oo(i, n, a) {
      if (!He) {
        ...
        if (((Ct = i.sm.zooming_dimensions.r), Co(i, n), it || (mt && !B) || n))
            ...
            for (var r = [], s = 0; s < n.states.length; s++) {
              ...
              c
                ? c.sm.region
                  ...
                  : ((c.sm.region = e),
                    a.sm.states.push(l),
                    (it && c.sm.ignore_hover && (i.color || i.hover_color)) ||
                      a.push(c),
                    r.push(c.sm.bbox))
        ...
        if (
          ...
          "object" == typeof x
            ? (((ge = {}).sm = { type: "manual", zp: 1, bbox: x }),
              (ge.sm.zooming_dimensions = wo(ge)),
              (x = -1),
              (w = !1))
            : -1 == x ||
              x in ve ||
    ...
    function Ho() {
      for (var t in (o.clear_sets([Xt, Bt, Ht]),
      (be = {}),
      (ke = {}),
      (xe = {}),
      (se = se.reverse()),
          ...
          if ((e.parent_type, m)) {
              ...
              e.display
                ...
                : "region" == e.parent_type
                  ...
                  : "location" == e.parent_type
                    ...
                    : (v.sm.display = _.labels_display
                        ? _.labels_display
                        : "all"),
              (v.sm.display_ids = !!e.display_ids && e.display_ids),
              (e.line || e.pill || u) && (v.sm.bbox = Do(v)),
            ...
            if ("state" == m.sm.type && e.pill) {
              ...
              if (
                ...
                m.sm.image &&
                  (G.sm.over_attributes.fill = oe[m.sm.id].hover_color),
        ...
        t.sm.labels.forEach(function (t) {
          if (t.sm) {
            ...
            "over" == e
              ...
              : ("reset" != e && "out" != e) ||
                (Ue(t, "out"),
                n && (Ze(n, "out", i), o && Ze(n, "adjacent", i)));
          }
        });
    }
    ...
    function Uo() {
      ((Oe = function () {
        ...
        (Se = function () {
          if (
            (yo(), no(), si(), (this.id || "set" != !this.type) && !Ge && !mo)
          ) {
            var t = Vo(this);
                ...
                if (
                  ...
                  if (!M) {
                    if (
                      ...
                      return;
                    (t.sm.ignore_hover || (Ue(t, "over"), Ee(t)),
                      Xo(t, "over"));
                  }
                } else {
                  if (
        ...
        if (!(He || qe || We)) {
          ...
          if (!i.sm.inactive && (lo(i, o), !t.ignore_clicks)) {
            ...
            if (
              ...
              (Ne = i.sm.popup_off),
              !i.sm.zoomable ||
                ("region" != i.sm.type && ye == i && "out" != i.sm.type))
            )
              if (rt) {
                if (
                  (z == i ||
    ...
    function Ko(t) {
      if (!t) {
        (at
          ? (qt.mouseup(Te), Nt.mouseup(to), Zt.mouseup(Pe), Nt.mouseup(si))
          : (qt.hover(Se, Be),
            qt.click(Te),
            Nt.click(to),
            Zt.click(Pe),
          ...
          (ht.onwheel = function (t) {
            ht.mouseIsOver &&
              g &&
              A &&
              (t.preventDefault(), t.deltaY < 0 ? $t() : te());
          }),
          ...
          Yt.forEach(function (t) {
            "image" != ie[t.sm.id].type &&
              ((t.sm.attributes["stroke-width"] =
                ie[t.sm.id].border * (xt / zt) * At * 1.25),
        ...
        : (_o(),
          ...
          (function () {
            if (
              ...
              var t = T || Et;
              ((Dt = St.image(C, t.x, t.y, t.x2 - t.x, t.y2 - t.y)),
                Nt.push(Dt));
            }
            (Nt.push(Lt),
              Nt.transform(jt),
          ...
          (function () {
            ...
            if (l) {
              ...
              ((e.href = "https://www.openstreetmap.org/copyright"),
                (e.title = "Background Â© OpenStreetMap contributors"),
          ...
          (je = {
            ...
            show: function (t) {
              Ne ||
                ...
                (O.style.zIndex = 2),
                (O.style.maxWidth = pe + "px"),
                (O.innerHTML = t.sm.content),
                je.update_pos(t));
            },
            ...
            set_pos: function (t, e, o) {
              if (O) {
                ...
                if (
                  ...
                  if (((B = 0 + 0.5 * wt), e > (S = 0 + 0.5 * xt) && t > B))
                    r = 4;
                  else if (e < S && t > B) r = 3;
                  else if (e > S && t < B) r = 2;
                  else var r = 1;
                  ("below" == P
                    ...
                    1 == r
                      ? ((O.style.bottom = "auto"),
                        (O.style.top = t + 5 + "px"),
                        (O.style.left = e + 5 + 5 + "px"),
                        (O.style.right = "auto"))
                      : 2 == r
                        ? ((O.style.bottom = "auto"),
                          (O.style.top = t + 5 + "px"),
                          (O.style.right = xt - e + 5 + "px"),
                          (O.style.left = "auto"))
                        : 3 == r
                          ? ((O.style.bottom = wt - t + 5 + "px"),
                            (O.style.top = "auto"),
                            (O.style.left = e + 5 + 3 + "px"),
                            (O.style.right = "auto"))
                          : ((O.style.bottom = wt - t + 5 + "px"),
                            (O.style.top = "auto"),
                            (O.style.right = xt - e + 5 + "px"),
                ...
                var e = void 0 === _.states_title ? "States" : _.states_title,
                  ...
                  n =
                    void 0 === _.locations_title
                      ...
                      : _.locations_title,
                  a = {
                    state: { title: e, array: fe },
                    location: { title: n, array: ze },
                    region: { title: i, array: ve },
                  };
                for (var r in a) {
                  var s = a[r],
    ...
    function ai(t, e, o) {
      (void 0 === e && (e = 4),
        void 0 === o && (o = function () {}),
        Oo({ sm: { type: "manual", zp: e, bbox: t } }, !1, function () {
          (o(), Zt.show());
        }));
    }
...
//   console.warn(
//     "[VN Map Partner] Bạn đang dùng file countrymap.js PLACEHOLDER.\n" +
//       "Hãy thay file này bằng countrymap.js thực tế từ simplemaps.",
//   );
// }
