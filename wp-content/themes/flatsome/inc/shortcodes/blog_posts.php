...
while ( $recentPosts->have_posts() ) : $recentPosts->the_post();
		...
		?>
		<div class="col post-service-item  <?php echo implode(' ', $col_class); ?>" <?php echo $animate;?>>
			<div class="col-inner">
          ...
          <?php } ?>
					...
					<?php } ?>
					<h5 class="service-title post-title is-<?php echo $title_size; ?> <?php echo $title_style;?>"><?php the_title(); ?></h5>
